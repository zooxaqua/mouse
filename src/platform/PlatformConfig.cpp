...
const PlatformConfig g_platformConfig = []() {
    ...
    // --- モーター制御系 ---
    cfg.motor1In1 = { 26, PinModeType::PWM_OUT, 0, 40000, 8 }; // G26 → DRV8835 AIN1
    cfg.motor1In2 = { 18, PinModeType::PWM_OUT, 1, 40000, 8 }; // G18 → DRV8835 AIN2
    cfg.motor2In1 = { 21, PinModeType::PWM_OUT, 2, 40000, 8 }; // G21 → DRV8835 BIN1
    cfg.motor2In2 = { 22, PinModeType::PWM_OUT, 3, 40000, 8 }; // G22 → DRV8835 BIN2
